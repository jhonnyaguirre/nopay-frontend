      ...
      <section className={`max-w-7xl mx-auto px-6 py-16 lg:py-24 lg:flex lg:items-center lg:gap-12 ${isMobile && showOverlay ? 'hidden' : ''}`}>
        <div className="max-w-2xl mb-16 lg:mb-0">
          ...
          >
            ...
            <Link
              href="#como-funciona"
              className="inline-flex items-center justify-center border-2 border-white/50 text-white font-medium px-5 py-2 rounded-xl hover:bg-white/10 transition-all"
            >
              Cómo funciona
            </Link>
          </motion.div>
