...
const TermsModal = ({
  ...
  useEffect(() => {
    ...
    const checkIfScrolledToBottom = () => {
      ...
      const atBottom = scrollTop + clientHeight >= scrollHeight - 5; // más flexible
      if (atBottom) setButtonEnabled(true);
    };

    // Verifica al montar (por si ya está abajo)
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 px-4 sm:px-6 py-8">
      <motion.div
