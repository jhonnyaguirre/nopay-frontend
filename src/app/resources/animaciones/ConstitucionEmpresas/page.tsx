...
import { FileText, BadgeCheck, Building2, Zap } from 'lucide-react';

const EmpresaOverlay = () => {
  ...
  const steps = [
    {
      ...
      text: 'Recopilando datos básicos...'
    },
    {
      icon: <BadgeCheck className="w-5 h-5 text-white" />,
      text: 'Generando acta y estatutos...'
    },
    {
      icon: <Building2 className="w-5 h-5 text-white animate-pulse" />,
      text: 'Registrando oficialmente la empresa'
    }
  ];
      ...
      >
        ...
        <div className="flex-1 p-5 space-y-4 overflow-hidden">
          <div className="text-center">
            ...
            <h2 className="text-sm font-bold text-[#10B981] mb-1">Motor de Constitución</h2>
            <p className="text-[10px] text-gray-400">Gestión empresarial digital</p>
          </div>
